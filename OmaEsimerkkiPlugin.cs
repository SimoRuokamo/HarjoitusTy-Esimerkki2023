...
namespace BIMKurssi
{
    ...
    /// </summary>
    public class OmaEsimerkkiPlugin : PluginTool, IModelViewFeature
    {
        #region ei muutoksia
        ...
        internal OmaEsimerkkiDialogViewModel _viewModel;
        public OmaEsimerkkiPlugin()
        {
            ...
            _viewModel = new OmaEsimerkkiDialogViewModel();
        }
        #region ei muutoksia
        ...
        {
            OmaEsimerkkiRakenne esimerkki = IsInEditMode ? PluginDataNode as OmaEsimerkkiRakenne : null;
            inputPointIndex = 0;
        ...
        private List<BaseDataNode> Excecute(bool previewMode, out Action doDelegate, out Action undoDelegate, out List<BaseDataNode> update3DNodes)
        {
            ...
            {
                OmaEsimerkkiRakenne rakenne = CreateOrUpdateModel(_viewModel);
 ...
 //                   Target.RemoveChild(rakenne);
            ...
            {
                OmaEsimerkkiRakenne rakenne = PluginDataNode as OmaEsimerkkiRakenne;
        ...
        /// <returns></returns>
        private OmaEsimerkkiRakenne CreateOrUpdateModel(OmaEsimerkkiDialogViewModel parametrit, OmaEsimerkkiRakenne oldEsimerkki=null)
        {
            OmaEsimerkkiRakenne retVal;
            // onko kysessä uuden luonti vai olemassa olevan muokkaaminen
            if (oldEsimerkki == null)
            {
                // luodaan uusi
                retVal = new OmaEsimerkkiRakenne();
            } else
            {
                // muokataan vanhaa
                retVal = oldEsimerkki;
            ...
            TimberMember3D mem = new Epx.BIM.Models.Timber.TimberMember3D();
            mem.Name = "Vaakassa";
